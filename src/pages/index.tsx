...
import CheckList from '@project/components/ui/CheckList'
import Features from '@project/components/ui/Features'
import LandingHeader from '@project/components/ui/LandingHeader'
...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center py-2">
      <Head>
        <title>Srovnání Next.js, Astro a Qwik</title>
      </Head>
      <LandingHeader />
      <Features
        header={{
